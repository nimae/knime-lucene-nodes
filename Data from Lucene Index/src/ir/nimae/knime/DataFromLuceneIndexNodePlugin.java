 ...
 */
public class DataFromLuceneIndexNodePlugin extends Plugin {
    // The shared instance.
    private static DataFromLuceneIndexNodePlugin plugin;

    /**
     * The constructor.
     */
    public DataFromLuceneIndexNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DataFromLuceneIndexNodePlugin getDefault() {
        return plugin;
    }
