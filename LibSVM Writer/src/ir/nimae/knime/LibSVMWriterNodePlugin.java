 ...
 * @author 
 */
public class LibSVMWriterNodePlugin extends Plugin {
    // The shared instance.
    private static LibSVMWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public LibSVMWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static LibSVMWriterNodePlugin getDefault() {
        return plugin;
    }
